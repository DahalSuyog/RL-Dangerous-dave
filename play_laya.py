"""Watch Laya (Convai Innovations) play Dangerous Dave.

Usage:
    python play_laya.py

Runs entirely locally - no API key required. The first run downloads Laya's model weights
from Hugging Face Hub (one-time, cached thereafter).
"""
...
from laya_agent import LayaAgent  # noqa: E402
